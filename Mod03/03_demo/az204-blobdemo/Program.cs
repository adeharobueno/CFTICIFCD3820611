...
namespace az204_blobdemo
{
    class Program
    {
        ...
        private static async Task ProcessAsync()
        {
            ...
            string storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=az204blobdemo77768;AccountKey=QDNXJSGTvyZ5Fe/9fWgxmM39A+o2u8qrbK+KcoJ9nmDKugZ7XNN8QdYAGQIL+OyQVh+N7RrHzyto+nzQMfrhSQ==;EndpointSuffix=core.windows.net";
